        ...
        <div>
            <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
                <div>
                    ...
                    <h1 className='prata-regular text-3xl'>PhucHung</h1>
            ...
            <div >
                <hr />
                <p className='py-5 text-sm text-center'>Copyright 2025@ PhucHungFashion - All rights reserved.</p>
            </div>
