...
const Login = ({setToken}) => {
    ...
    const onSubmitHandler = async (e) => {
        try {
          ...
          e.preventDefault();
          const response = await axios.post(backendUrl + '/api/user/admin', {email, password: password})
      ...
      <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        ...
        <form onClick={onSubmitHandler}>
            <div className='mb-3 min-w-72'>
                <p className='tetx-sm font-medium text-gray-700 mb-2'>Email Address</p>
            ...
            <div className='mb-3 min-w-72'>
                <p className='tetx-sm font-medium text-gray-700 mb-2'>Password</p>
